...
<?php $allchaptertitle = ob_get_clean(); ?>
 ...
 <?php ob_start(); ?>
					<form class="form-log-in" method="post" action="index.php?action=addPost" style="width:70em">
						<p>
							<input type="text" id="titre" name="titre" placeholder="Titre du nouveau chapitre"  style="width:50em; border-radius: 7px;" />
						</p>
						<p>
